import { fetchAllSubmittedWork } from "@/redux/API/submittedWorkAPI";
import { useAppDispatch, useAppSelector } from "@/redux/hooks";
import {SubmittedWork, TabsNavigationTypes, TimeFilter } from "@/utils/types";
import { useTranslations } from "next-intl";
import { useEffect, useMemo, useState } from "react";

interface Props {
  currentTab: TabsNavigationTypes;
  setSelectedSubmission: React.Dispatch<React.SetStateAction<Partial<SubmittedWork>>>;
  setShowSubmission: React.Dispatch<React.SetStateAction<boolean>>;
}
const AdminSubmittedWork = ({ currentTab, setSelectedSubmission, setShowSubmission }: Props) => {
  const now = new Date();
  ...
  function showSubmissionDetails(submission: SubmittedWork) {
      ...
      >
        ...
        <div className="table-responsive">
          <table>
            ...
            <tbody id="submittedWorkTable"  style={{width: "100%"}}>
...
export default AdminSubmittedWork;
