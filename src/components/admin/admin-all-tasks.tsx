...
const AdminAllTasks = ({ currentTab, setShowNewTaskModal, setSelectedTask, setShowViewTask, setShowReAssignTask }: Props) => {
                  ...
                  <tr key={task.id}>
                    ...
                    <td>
                      <div
                        ...
                        style={{ padding: "6px 12px", minWidth: "140px", textAlign: "center" }}
                      >
